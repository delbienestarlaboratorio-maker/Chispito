...
// Pre-render ALL grades (including telesecundaria and bachillerato) so the Edge worker doesn't need to SSR them
...
export async function generateStaticParams() {
    ...
    for (const grado of Object.keys(GRADOS_CONTENIDO)) {
        if (!ALL_GRADES_SLUGS.includes(grado)) continue;
